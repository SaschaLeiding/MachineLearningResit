...
{
 combined_plots <- ((plot_fit_comp_corr_in + plot_fit_regul_corr_in + plot_fit_cvregul_corr_in)/
                     (plot_fit_comp_corr_out + plot_fit_regul_corr_out + plot_fit_cvregul_corr_out)) + 
...
# (5) Regularized Model - Double LASSO
