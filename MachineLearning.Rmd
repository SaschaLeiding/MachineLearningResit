...
# Estimation of Models
{
  ...
  simplemodels_list[[paste0("model_regul_", name_outcome)]]<- linear_reg(penalty = 0.01, mixture = 1) %>%
    set_engine('glmnet') %>%
    fit_xy(y = Y_train, x = X_train)
  ...
  # (4) Regularized Model - Double LASSO - lambda CV
  {
...
# Plotting of in-/out-of-sample fit
{
...
# TRIPLE LASSO IV- requires that Z is a scalar Instrument
{
